...
import { chats } from "./src/template/chats.js";
import { messages } from "./src/template/messages.js";
import { currentMessage } from "./src/template/current-message.js";

export default defineConfig({
    plugins: [
        handlebars({
        partialDirectory: resolve(__dirname, "src/elements"),
        context: {
            chats,
            currentMessage,
            messages,
